...
class Album
{
    ...
    private string|null $albumTypeName;
    private $db;
    ...
    public function __construct($id, $db)
    {
        ...
        $this->albumTypeId = $result['type_id'];
        if ($this->albumTypeId !== null) {
            $sql = "SELECT name FROM album_types WHERE id = $this->albumTypeId";
            $this->albumTypeName = $db->query($sql)->fetch_assoc()['name'] ?? null;
        } else {
            $this->albumTypeName = null;
        }
    ...
    public function getAlbumTypeId(): ?int
    {
        return $this->albumTypeId;
    }

    public function getAlbumTypeName(): string|null
    {
    ...
    public function setAlbumTypeId(int $albumTypeId): void
    {
