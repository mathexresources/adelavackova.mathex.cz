...
<div class="col">
    <div class="position-fixed top-0 d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="/albumTypes" class="nav-link  <?= ($path == '/albumTypes') ? 'active' : 'text-dark' ?>" style="padding-left: 2.25rem;">
                    <i class="fa fa-tags pe-none me-2"></i>
                    Typy alb
                </a>
            </li>
            <?php } ?>
            ...
            <li class="nav-item">
                <a href="/contactDetails"
                   class="nav-link  <?= ($path == '/contactDetails') ? 'active' : 'text-dark' ?>">
