...
?>
<div class="container <?= ($page == 'album') ? 'position-absolute start-50 translate-middle-x' : '' ?> customNavbar" style="z-index: 3; min-width: 90vw">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom border-dark">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
            <svg class="bi me-2" width="40" height="32">
                <use xlink:href="#bootstrap"></use>
            </svg>
            <span class="fs-4 asset-regular" style="font-family: Asset !important;">A. Bartůňková</span>
        </a>
